...
// climatiq road travel api
 const climatiqUrl = 'https://beta3.api.climatiq.io/estimate';
 const climatiqToken = 'SVR2BFSQ4PMS2YKZ2350TK547RH4';


 function roadTravelEmission () {

    fetch(climatiqUrl {
        method: 'POST',
        headers: {
            "Authorization": 'Bearer' + climatiqToken,
            "Content"
        }
    })
 }